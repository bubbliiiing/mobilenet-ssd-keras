...
| :-----: | :-----: | :------: | :------: | :------: | :-----: |
| VOC07+12 | [mobilenet_ssd_weights.h5](https://github.com/bubbliiiing/mobilenet-ssd-keras/releases/download/v1.0/mobilenet_ssd_weights.h5) | VOC-Test07 | 300x300| - | 68.98
...
## 预测步骤
### a、使用预训练权重
1. 下载完库后解压，在百度网盘下载mobilenet_ssd_weights.h5，放入model_data，运行predict.py，输入  
```python
img/street.jpg
```
